const ApiKey = "c7d0b22863fb42bea705119d0042d264";
        ...
        .then(restJson => {
            ...
            teams += `
                ...
                <div class="row">
                    ...
                    <div class="col s8">
                        <ul class="collection">
                            <li class="collection-item"><h3>${restJson.name}</h3></li>
                            ...
                            <li class="collection-item">Contact : ${restJson.phone}</li>
